...
function packkeys.cockey()
	...
	keyset("x", "<leader>f", "<Plug>(coc-format-selected)", { silent = true, nowait = true })
...
-- carbon keybindings
--]]
function packkeys.carbon()
	keyset("n", "<leader>q", ":Fcarbon<CR>", { nowait = true, noremap = true })
end
